...
<!-- Welcome Section -->
<div class="welcome-section container-fluid p-5 text-white text-center justify-content-center welcome-section">
  <div class="container video-container">
    <video src="assets/videos/planet-rotate.mp4" autoplay loop muted class="welcome-video"></video>
    <div class="d-flex flex-column justify-content-center h-100">
      <h1 class=" display-4 mt-5 p-1 mb-3 text-center welcome-title">DeKUT Responsible Computing</h1>
      <p class="text-warning welcome-subtitle">Navigating the Digital Frontier with Responsibility, Secure, Ethical & Inclusive Computing</p>
    </div>
    <i class="lead bi bi-arrow-down-circle text-warning"></i>
  </div>
</div>
  ...
  <div class="container mission d-flex align-items-center mb-5">
    <div class="row">
      ...
      <div class="col-md-6 mission-div mt-5">
        <h2 class="text-center fw-bold mission-title">Our Mission</h2>
        <p class="mission-text text-justify">
...
<div class="container-fluid why">
  <div class="container  d-flex align-items-center why-space mb-5 mt-5">
    <div class=" row align-items-center">
      <div class="col-md-6">
        <h2 class="text-center fw-bold">Why Responsible Computing ?</h2>
        <p class="text-justify ">
      ...
      <div class="col-md-6">
        <img src="assets/images/mozilla.png" class="rounded img-fluid ">
      </div>
