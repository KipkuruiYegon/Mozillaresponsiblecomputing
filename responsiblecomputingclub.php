...
<div class="container-fluid">
    <div class="container mt-5 mb-5 ">
        <div class="row">
            <div class="col-md-6">
                <h2>Responsible Computing Club Activities</h2>
                ...
                <p>We believe in giving back to the community. Our volunteering activities include organizing computer literacy programs for local schools and collaborating with nonprofit organizations to develop software solutions that address societal challenges.</p>
            ...
            <div class="col-md-6">
                ...
                <p class="mt-5">. No vacancies at the moment, updating soon</p>
            </div>
        </div>
    </div>
</div>
